...
# Function to scale and reshape data for RNN
...
# Function to build the Vanilla RNN model
def build_vanilla_rnn_model(input_shape):
    """
    Build and compile the Vanilla RNN model.
    """
    model = Sequential([
...
if __name__ == "__main__":
    ...
    model = build_vanilla_rnn_model((1, len(features)))
